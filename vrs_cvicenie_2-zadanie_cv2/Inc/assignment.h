...
#define LED_ON(Pin)				*((volatile uint32_t *)((uint32_t)(0x48000000 + 0x18U))) |= (1 << Pin) /* Add LED_ON implementation here. */
#define LED_OFF(Pin)				*((volatile uint32_t *)((uint32_t)(0x48000000 + 0x28U))) |= (1 << Pin)/* Add LED_OFF implementation here. */

#define BUTTON_GET_STATE(Pin)	(*((volatile uint32_t *)((uint32_t)(0x48000000 + 0x10U))) & (1 << Pin))/* Add BUTTON_GET_STATE implementation here. */
